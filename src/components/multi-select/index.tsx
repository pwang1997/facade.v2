...
const MultiSelect = ({ label, values, onValuesChange, data }: { data: unknown[] } & MultiSelectorProps) => {
  return (
    <>
      ...
      <MultiSelector values={values} onValuesChange={onValuesChange} loop={false}>
        ...
        <MultiSelectorContent>
          <MultiSelectorList>
            {data?.map((item, i) => (
              <MultiSelectorItem key={i} value={item?.name as string}>
                {item?.name as string}
              </MultiSelectorItem>
            ))}
          </MultiSelectorList>
...
export { MultiSelect, MultiSelector, MultiSelectorContent, MultiSelectorInput, MultiSelectorItem, MultiSelectorList, MultiSelectorTrigger };
